...
import PreregistrationTable from "@/components/tables/PreregistrationTable";
type Props = {
};
    ...
    <div className="flex h-full">
      ...
      <div className="container main">
          ...
          <section>
            ...
            <div className="mt-3">
              <PreregistrationTable  apiState={preregistrations} />
            </div>
          </section>
